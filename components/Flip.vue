  ...
  <div class="flipper">
    <div v-if="haveValidCards()" class="flipper__deck">
      ...
      <div class="flipper__nav">
        <button @click="prevCard()" class="btn btn-mini">
          <svg
            class="w-12 h-12"
            alt="Previous"
        ...
        <button @click="shuffle()" class="btn btn-mini">
          <svg
            class="w-12 h-12"
            alt="Shuffle"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <button v-if="speech" @click="speak()" class="btn btn-mini">
          <svg
            class="w-12 h-12"
            alt="Speak"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <button @click="nextCard()" class="btn btn-mini">
          <svg
            class="w-12 h-12"
            alt="Next"
            xmlns="http://www.w3.org/2000/svg"
...
const emit = defineEmits(['shuffle', 'speak']);
